  ...
  return (
    <>
      ...
      <div className='flex'>
        <div className='w-[25%]'/>  
        <div className='w-[50%]'>
          <h2 className='text-center text-xl underline m-3 scroll-m-3' id='About-Me'>About Me</h2>
          ...
          <h2 className='text-center text-xl underline m-3 scroll-m-3' id='Projects'>Projects</h2>
          <Project
